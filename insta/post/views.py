...
class RecommendListView(LoginRequiredMixin, ListView):
    model = User
    template_name = "post/recommend_list.html"
    context_object_name = "recommends"

    def get_recommend(self, queryset=None):
        return render(redirect, 'post/recommend_list.html')
